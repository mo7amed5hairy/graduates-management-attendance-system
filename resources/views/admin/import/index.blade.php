  ...
  <div class="card p-6 mb-6">
    ...
    <ul class="text-sm text-slate-600 space-y-1 list-disc pr-5">
      ...
      <li>صيغة Excel المدعومة تحتوي على الأعمدة التالية بالترتيب:
        <span class="block mt-1 text-xs text-slate-500">مسلسل | الحالة | الاسم الكامل مع اللقب | العمر | الجنس | عنوان السكن الحالي | سنة تخرج | التحصيل الدراسي | رقم الهاتف | اسم الام الرباعي | الحالة الاجتماعية</span>
      </li>
